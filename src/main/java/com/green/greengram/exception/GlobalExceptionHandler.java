...
/*
Advice 라는 단어가 보이면 AOP 라고 인식하면됨
AOP (Aspect Oriented Programming , 관점지향 프로그레밍 )
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private MyErrorResponse makeErrorResponse(ErrorCode errorCode, BindException e) {
        return MyErrorResponse.builder()
                ...
                .valids(e ==null ? null : getValidationError(e)) // validation 에러메시지를 정리
                .build();
    }
    private List<MyErrorResponse.ValidationError> getValidationError(BindException e) {
        ...
        for(FieldError fieldError : fieldErrorList) {
            ...
            //list.add(MyErrorResponse.ValidationErrorof.of(fieldError))
        }
        return list;
    }
}
